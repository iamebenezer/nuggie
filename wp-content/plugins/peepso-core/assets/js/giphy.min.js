! function s(o, n, r) {
    ...
    1: [function(t, e, i) {
        "use strict";
        var s, o, h, r, n;
        s = window, o = n = "PsGiphyComment", h = s.jQuery, r = t("./giphy.js"), o = peepso.createClass(o, {
            __constructor: function() {
                this.template = peepsogiphydata.dialogGiphyTemplate, peepso.observer.addFilter("comment_show_button", this.shouldShowButton, 10, 1), peepso.observer.addFilter("comment_can_submit", this.isSubmittable, 10, 1), peepso.observer.addFilter("comment_req", this.filterRequest, 10, 2), peepso.observer.addAction("comment_edit", this.onEdit, 10, 2), h(h.proxy(this.onDocumentLoaded, this))
            },
            onDocumentLoaded: function() {
                h(document).on("click", ".ps-js-comment-giphy", h.proxy(this.onAttach, this)), h(document).on("click", ".ps-js-addon-giphy .ps-js-remove", h.proxy(this.onRemove, this)), h(document).on("ps_comment_aftersave", h.proxy(this.onSaved, this))
            },
            onAttach: _.throttle(function(t) {
                var e, i = "ps-giphy-initialized",
                    s = "ps-giphy-loading",
                    o = peepso.rtl,
                    n = h(t.currentTarget);

                function r(t) {
                    t.show(), t[0].focus(), t.css({
                        backgroundColor: peepso.getLinkColor()
                    }), t.css({
                ...
                t.preventDefault(), t.stopPropagation(), n = n.closest(".ps-js-comment-new, .ps-js-comment-edit"), (e = n.prev(".ps-js-giphy-container")).length || ((e = h(this.template)).data("act-id", n.data("id")), e.find(".ps-js-giphy-list").css("transition", `margin-${o?"right":"left"} .5s`), e.hide().insertBefore(n), e.on("input", ".ps-js-giphy-query", h.proxy(this.onSearch, this)), e.on("click", ".ps-js-giphy-list img", h.proxy(this.onSelectImage, this)), e.on("click", ".ps-js-giphy-nav-left", t => this.onScroll(t, "left")), e.on("click", ".ps-js-giphy-nav-right", t => this.onScroll(t, "right"))), e.is(":visible") ? e.hide() : (e.show(), e.data(i) || e.data(s) ? r(e.find(".ps-js-giphy-query")) : (e.data(s, !0), this.search(e).done(h.proxy(function() {
            ...
            search: function(o, n) {
                return h.Deferred(h.proxy(function(e) {
                    ...
                    t.search(n).done(h.proxy(function(t) {
                ...
                var i = t.find(".ps-js-giphy-list"),
                    ...
                    e = _.map(e, function(t, e) {
                        var i, s = t.images,
                            o = s[p],
                            n = "";
                        return o && (i = s.preview_gif || s.downsized_still || s.fixed_width_still || s.original_still) && (h.extend(t, {
                            src: o.url,
                            preview: i.url
                        }), n = r(t)), n
                    });
            ...
            onScroll: function(t, e) {
                ...
                e === (i ? "right" : "left") ? s = Math.min(s + t, 0) : e === (i ? "left" : "right") && (e = o.children(".ps-js-giphy-item").last(), e = i ? Math.abs(e.position().left) : e.position().left + e.width() - t, s -= Math.min(t, e)), o.css(i ? "marginRight" : "marginLeft", s)
            },
            ...
            shouldShowButton: function(t) {
                var e, i = h(t.el).closest(".ps-js-comment-new, .ps-js-comment-edit").find(".ps-js-addon-giphy");
            ...
            filterRequest: function(t, e) {
                var i, e = h(e).closest(".ps-js-comment-new, .ps-js-comment-edit").find(".ps-js-addon-giphy");
            ...
            onEdit: function(t, e) {
                var i = h(e).find(".ps-js-addon-giphy"),
                    e = i.find(".ps-js-img");
                e.length && e.attr("src") ? (i.find(".ps-js-remove").show(), i.find(".ps-js-img").show(), i.show(), h(document).trigger("ps_comment_addon_added", i)) : (i.find(".ps-js-remove").hide(), i.find(".ps-js-img").hide(), i.hide(), h(document).trigger("ps_comment_addon_removed", i))
            }
        }), "object" == typeof e && e.exports ? e.exports = o : s[n] = o, new o
    }, {
        "./giphy.js": 2
    }],
    2: [function(t, e, i) {
        "use strict";
        var s, o, n, r, p;
        s = window, n = "PsGiphy", o = s.jQuery, r = peepso.createClass(n, {
            __constructor: function() {
            ...
            search: function(i) {
                return i = o.trim(i || ""), o.Deferred(o.proxy(function(e) {
                    this._result || (this._result = {});
                    var t = this._result[i];
                    t ? e.resolveWith(this, [t]) : this._giphy(i).done(o.proxy(function(t) {
            ...
            _giphy: function(t) {
                ...
                return this.rating && (i.rating = this.rating), t && (e = "https://api.giphy.com/v1/gifs/search", i = _.extend(i, {
                    q: t,
                    offset: 0
                })), o.get(e, i)
            }
    ...
    3: [function(o, t, e) {
        ! function(i) {
            ! function() {
                "use strict";
                var t, s = (t = "undefined" != typeof window ? window.jQuery : void 0 !== i ? i.jQuery : null) && t.__esModule ? t : {
                        default: t
                    },
                    e = "undefined" != typeof window ? window.peepso : void 0 !== i ? i.peepso : null;
                o("./comment"), o("./message"), o("./postbox"), e.observer.addFilter("human_friendly_extras", function(t, e, i) {
    ...
    4: [function(t, e, i) {
        "use strict";
        var s, o, h, r, n;
        s = window, o = n = "PsGiphyMessage", h = s.jQuery, r = t("./giphy.js"), o = peepso.createClass(o, {
            __constructor: function() {
            ...
            onToggle: function(t) {
                ...
                t.preventDefault(), t.stopPropagation(), e.is(":visible") ? e.hide() : (e.show(), e.data(i) || e.data(s) ? o(e.find(".ps-js-giphy-query")) : (e.data(s, !0), e.on("input", ".ps-js-giphy-query", h.proxy(this.onSearch, this)), e.on("click", ".ps-js-giphy-list img", h.proxy(this.onSelectImage, this)), e.on("click", ".ps-js-giphy-nav-left", t => this.onScroll(t, "left")), e.on("click", ".ps-js-giphy-nav-right", t => this.onScroll(t, "right")), this.search(e).done(h.proxy(function() {
            ...
            post: function(t, e) {
                peepso.observer.doAction("msgso_send_message", t, "", {
                    type: "giphy",
                    giphy: e
                })
            }
        }), "object" == typeof e && e.exports ? e.exports = o : s[n] = o, new o, peepso.observer.addFilter("giphy_rendition_posts", function(t, e) {
        ...
        ! function(o) {
            ! function() {
                ...
                class s {
                    ...
                    search(t = "") {
                        return this.$result.hide(), this.$loading.show(), r.default.Deferred(e => {
                        ...
                        let n = p.observer.applyFilters("giphy_rendition_posts", peepsogiphydata.giphy_rendition_posts || "fixed_width", this.$postbox),
                            e = t.map(t => {
                                var e, i = t.images,
                                    s = i[n],
                                    o = "";
                                return s && (e = i.preview_gif || i.downsized_still || i.fixed_width_still || i.original_still) && (r.default.extend(t, {
                                    src: s.url,
                                    preview: e.url
                                }), o = this.itemTemplate(t)), o
                            });
                    ...
                    scroll(t) {
                        let e = p.default.rtl,
                            ...
                            r;
                        t === (e ? "right" : "left") ? n = Math.min(n + o, 0) : t === (e ? "left" : "right") && (t = s.children(".ps-js-giphy-item").last(), r = e ? Math.abs(t.position().left) : t.position().left + t.width() - o, n -= Math.min(o, r)), s.css(e ? "marginRight" : "marginLeft", n)
                    }
                    onChangeImage(t) {
                ...
                p.observer.addAction("peepso_postbox_addons", t => {
                    return t.push({
                        init() {},
                        set_postbox(t) {
